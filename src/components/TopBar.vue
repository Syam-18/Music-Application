<template>
  <div class="topbar">
    ...
    <div class="center-nav">
      <button class="center-nav-btn" :class="{ active: $route.name === 'Home' }" @click="$router.push('/')">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12.5 3.247a1 1 0 00-1 0L4 7.577V20h4.5v-6a1 1 0 011-1h5a1 1 0 011 1v6H20V7.577l-7.5-4.33z" />
        </svg>
        Home
      </button>
      <button class="center-nav-btn" :class="{ active: $route.name === 'Search' }" @click="$router.push('/search')">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          <path
    ...
    <div class="search-container">
      <div class="search-box">
        ...
        <input type="text" placeholder="Search..." @focus="$router.push('/search')" />
      </div>
    </div>
